...
=== Help Option
You can modify the implicitly create --help option. Use cli.helpOpt() to get a
...
| Usage
| cli.opt()
| Generated text list the defined positional arguments.
...
| ""   | ""   | "Options"
| Default group options are created
