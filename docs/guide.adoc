...
and cli.execAfter() to register exec actions to run them.

Let's add this source file to the "in seperate file" example to time how long
commands take to finish.
