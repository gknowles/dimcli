...
if "%p_generator%" equ "Visual Studio 16 2019" (
    call "%ProgramFiles(x86)%\Microsoft Visual Studio\2019\Community\Common7\Tools\VsDevCmd.bat" -arch=x64 -host_arch=x64
...
) else if "%p_generator%" equ "Visual Studio 18 2026" (
